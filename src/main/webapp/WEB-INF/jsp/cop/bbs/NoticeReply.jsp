    ...
    function fn_regist_notice() {
    	...
    	$("textarea[name=nttCn]").val(CrossEditor.GetBodyValue());
	        if(uploader.fileInfoMap.size==0){
	            document.board.action = "<c:url value='/cop/bbs/replyBoardArticle.do'/>";
...
<h2 class="hidden">컨텐츠영역</h2>
    ...
    <div class="panel-body">
        ...
        <div class="table-box table-row">
            <form name="board" method="post">
                 ...
                 <input type="hidden" name="adminLimitAt"  value="<c:out value='${result.adminLimitAt}'/>" />
				 <input type="hidden" name="fileAtchAt"  value="<c:out value='${result.fileAtchAt}'/>" />
				 <input type="hidden" name="fileAtchCnt"  value="<c:out value='${result.fileAtchCnt}'/>" />
				 <input type="hidden" name="replyPosbAt"  value="<c:out value='${result.replyPosbAt}'/>" />
             ...
             <table>
                 ...
                 <tbody>
                     <tr>
                         ...
                         <td>
                             <div>
                                    <input id="nttSj" name="nttSj" type="text" size="60" value="RE: ${result.nttSj}"  maxlength="60">
                                    <br/><form:errors path="nttSj" />
                             </div>
                         </td>
                     </tr>
                     <tr>
                         <th scope="row"><span>답글내용</span></th>
                         <td>
                        ...
                        <td>
                            <div class="col-12" style="display: block;">
                                 <div id="uploaderContainer" class="form_area">
                                     <form name="dataForm" method="post" action="/namo/crossuploader/Upload/FileUpload.do">
                                          <!-- 파일 정보를 저장할 폼 데이터 -->
                        ...
                        var onCloseMonitorWindowCu = function () {
                            ...
                            if (uploader.getUploadStatus() == 'COMPLETION') {
                                ...
                                */
                                ...
                                // 데이터 처리 페이지로 업로드 결과를 전송합니다.
                                //var obj = jQuery.parseJSON(uploadedFilesInfo);
                                document.board.fileInfo.value = uploadedFilesInfo;
    ...
    <div class="panel-footer">
        <div class="btn-area">
            <button type="button" class="btn btn-primary btn-lg" onclick="javascript:fn_regist_notice(); return false;">등록</button>
