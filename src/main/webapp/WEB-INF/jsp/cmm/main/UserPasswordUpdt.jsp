...
<section class="panel-wrap">
	...
	<form name="passwordChgVO" method="post" action="${pageContext.request.contextPath}/cmm/main/UserPasswordUpdt.do">
		...
		<div class="panel-body">
			...
			<div class="table-box table-row y-scroll content-height-1">
				<table>
					...
					<tr>
						<th scope="col" class="essential"><span>회원아이디</span></th>
						<td>
						...
						<th scope="col" class="essential"><span>기존 패스워드</span></th>
						<td>
							<input name="oldPassword" id="oldPassword" title="기존 패스워드" type="password" size="20" value="" maxlength="100" />
						</td>
					</tr>
					<tr>
						<th scope="col" class="essential"><span>변경 패스워드</span></th>
						<td>
							<div>
						...
						<th scope="col" class="essential"><span>패스워드 확인</span></th>
						<td>
							<div>
