                    ...
                    <div class="table-header">
                        ...
                        <div>
                        	<!--
               				...
               				-->
               				<!--  <button type="submit" class="btn btn-secondary btn-lg" onclick="javascript:fnexcel_DownloadUserView();">엑셀다운로드</button> -->
               				<button type="submit" class="btn btn-secondary btn-lg" onclick="fnexcel();">엑셀다운로드</button>
           				</div>
                    </div>
