...
function insertMenuManage(form) {
    ...
    if(!validateMenuManageVO(form)){
    	...
    	$('input[name="menuType"]').val($('input[name="menuTypeR"]:checked').val());
         form.action="<c:url value='/sys/menu/mlm/MenuRegistInsert.do'/>";
         form.submit();
    	}
    }
}
...
<section class="panel-wrap">
    ...
    <form:form commandName="menuManageVO" name="menuManageVO" method="post" action="${pageContext.request.contextPath}/sys/menu/mlm/MenuRegistInsert.do">
                       ...
                       <tr>
                            ...
                            <td>
                                <div class="label-input">
                                    <label><input type="radio" name = "useAt"  id="useAt" value="Y" checked />사용</label>
                                    <label><input type="radio" name = "useAt"  id="useAt" value="N" />미사용</label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="label-input">
                                    <label><input type="radio" name="menuTypeR" value="1" onclick="cheangeMenuType('1')" checked />콘텐츠</label>
                                    <label><input type="radio" name="menuTypeR" value="2" onclick="cheangeMenuType('2')" />프로그램</label>
                                    <label><input type="radio" name="menuTypeR" value="3" onclick="cheangeMenuType('3')" />링크</label>
                                    <label><input type="radio" name="menuTypeR" value="4" onclick="cheangeMenuType('4')" />게시판</label>
                                </div>
                                <div class="label-input mt15">
                                URL:<input id="url"  name="url" type="text"  value="${menuManageVO.url}"/>
                                <div id="menuType1">
	    ...
	    <div class="panel-footer">
	        <div class="btn-area">
	            <button type="button" class="btn btn-primary btn-lg" onclick="javascript:insertMenuManage(document.getElementById('menuManageVO')); return false;">등록</button>
