...
public class AuthorRoleManageDAO extends EgovAbstractDAO {
	...
	public AuthorRoleManageVO selectAuthorRole(AuthorRoleManageVO authorRoleManageVO) throws Exception {
		return (AuthorRoleManageVO) select("authorRoleManage.selectAuthorRole", authorRoleManageVO);
	}
	...
	public List<AuthorRoleManageVO> selectAuthorRoleList(AuthorRoleManageVO authorRoleManageVO) throws Exception {
		return (List<AuthorRoleManageVO>) list("authorRoleManage.selectAuthorRoleList", authorRoleManageVO);
	}
	...
	public void insertAuthorRole(AuthorRoleManage authorRoleManage) throws Exception {
		insert("authorRoleManage.insertAuthorRole", authorRoleManage);
	}
	...
	public void updateAuthorRole(AuthorRoleManage authorRoleManage) throws Exception {
		update("authorRoleManage.updateAuthorRole", authorRoleManage);
	}
	/**
	...
	public void deleteAuthorRole(AuthorRoleManage authorRoleManage) throws Exception {
		delete("authorRoleManage.deleteAuthorRole", authorRoleManage);
	}
	public void deleteAllAuthorRole(AuthorRoleManage authorRoleManage) throws Exception {
		delete("authorRoleManage.deleteAllAuthorRole", authorRoleManage);
	}
	public void deleteAllRoleCode(AuthorRoleManage authorRoleManage) throws Exception {
		delete("authorRoleManage.deleteAllRoleCode", authorRoleManage);
	}
	...
	public int selectAuthorRoleListTotCnt(AuthorRoleManageVO authorRoleManageVO) throws Exception {
		return (Integer)select("authorRoleManage.selectAuthorRoleListTotCnt", authorRoleManageVO);
	}
