package egovframework.appn.sys.author.arm.service;
...
public interface AuthorManageService {
	 ...
	 * @exception Exception
	 */
	public void insertAuthor(List<AuthorManage> authorManage) throws Exception;
	 ...
	 * @exception Exception
	 */
	public void updateAuthor(List<AuthorManage> authorManage) throws Exception;
