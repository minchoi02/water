package egovframework.appn.sys.user.urm.service;
...
public interface UserManageService  {
	...
	public List<?> selecAuthortUserList(UserDefaultVO userSearchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public String selectId(UserManageVO userManageVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public String selectIdByPwFind(UserManageVO userManageVO) throws Exception;
