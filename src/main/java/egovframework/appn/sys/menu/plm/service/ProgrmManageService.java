package egovframework.appn.sys.menu.plm.service;
...
public interface ProgrmManageService {
	 ...
	 * @exception Exception
	 */
	ProgrmManageVO selectProgrm(String progrmNm) throws Exception;
	/**
	 * 프로그램 목록을 조회
	 * @param vo ComDefaultVO
	 * @return List
	...
	List<?> selectTreeCodeList(AuthorVO vo) throws Exception;

	List<?> selectAuthorTreeList(AuthorVO vo) throws Exception;

	List<?> selectAuthorList() throws Exception;

	void updateTreeCode(List<AuthorVO> vo) throws Exception;
