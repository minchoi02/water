...
import egovframework.appn.sys.author.arm.service.impl.AuthorRoleManageDAO;
import egovframework.appn.sys.author.rem.service.RoleManage;
import egovframework.appn.sys.author.rem.service.impl.RoleManageDAO;
...
import egovframework.appn.sys.menu.plm.service.impl.ProgrmManageDAO;
...
//	CommonsMultipartResolver mailmultipartResolver;
	...
	public MenuManageVO selectMenuManage(String menuNo) throws Exception {
		return menuManageDAO.selectMenuManage(menuNo);
	}
	...
	public List<?> selectMenuManageListExcel(ComDefaultVO vo) throws Exception {
		return menuManageDAO.selectMenuManageListExcel(vo);
	}
	...
	public void insertMenuManage(MenuManageVO vo) throws Exception {
		...
		roleManage.setRoleCode(String.valueOf(vo.getMenuNo()));
		roleManage.setRoleNm(vo.getMenuNm());
		roleManage.setRolePtn(vo.getUrl());
		roleManage.setRoleDc(vo.getMenuNm());
		roleManage.setRoleTyp("url");
		roleManage.setRoleSort(String.valueOf(vo.getMenuOrdr()));
	...
	public void deleteMenuManage(MenuManageVO vo) throws Exception {
		...
		authorRoleManage.setRoleCode(String.valueOf(vo.getMenuNo()));

		MenuCreatVO menuCreatVO = new MenuCreatVO();
		menuCreatVO.setMenuNo(vo.getMenuNo());

		authorRoleManageDAO.deleteAllRoleCode(authorRoleManage);
		roleManageDAO.deleteRole(roleManage);
		//menuManage.deleteMenuCreatMenuNo
		menuCreateManageDAO.deleteMenuCreatMenuNo(menuCreatVO);
	...
	public List<?> selectMainMenuHead(MenuManageVO vo) throws Exception {
		// 로그인 사용자의 페이지뷰 정보 저장
		//menuManageDAO.insertPageView(vo);
	...
	@Override
	public int selectMaxMenuNo(MenuManageVO menuManageVO) throws Exception {
		return menuManageDAO.selectMaxMenuNo(menuManageVO);
	}

	@Override
	public void updateMenuOrder(List<MenuManage> menuManageList) throws Exception {

		for(int i=0;i<menuManageList.size();i++) {
			MenuManage menuManage = menuManageList.get(i);
			menuManage.setMenuOrdr(i);
			menuManage.setMenuNo(Integer.valueOf(menuManage.getId()));
			menuManageDAO.updateMenuOrder(menuManage);
		}
