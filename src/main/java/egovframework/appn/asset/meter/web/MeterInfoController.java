...
//        model.addAttribute("resultList", meterInfoList);
    ...
    public String updateMeterInfoView( @RequestParam("meterManagenum") String meterManagenum , @ModelAttribute("searchVO") MeterInfoDefaultVO searchVO, Model model) throws Exception {
