    ...
    if(confirm("삭제 하시겠습니까?")){
        varFrom.submit();
                ...
                <div class="sub_tit_wrap">
                	<h2>권한관리 <strong>상세(수정)</strong></h2>
                </div>
                <div id="sub_con_wrap">
                    ...
                    <div class="tablestyle_2" >
                        <table summary="권한을 수정하는 테이블입니다.권한 코드,권한 명,설명,등록일자 정보를 담고 있습니다.">
						  <tr>
						    ...
						    <td nowrap="nowrap"><input name="authorCode" id="authorCode" type="text" readonly="readonly" value="<c:out value='${authorManage.authorCode}'/>" size="40" title="권한코드" class="input_style1 input_w1"/>&nbsp;<form:errors path="authorCode" /></td>

						  </tr>
						  <tr>
						    <th scope="col" class="essential"><span>권한명</span></th>
						    <td nowrap="nowrap"><input name="authorNm" id="authorNm" type="text" value="<c:out value='${authorManage.authorNm}'/>" maxLength="50" size="40" title="권한명" class="input_style1 input_w6"/>&nbsp;<form:errors path="authorNm" /></td>

						  </tr>
						  <tr>
						    <th scope="col"><span>설명</span></th>
						    <td nowrap="nowrap"><input name="authorDc" id="authorDc" type="text" value="<c:out value='${authorManage.authorDc}'/>" maxLength="50" size="50" title="설명" class="input_style1 input_w3"/></td>
						  </tr>
						  <tr>
						    <th scope="col"><span>등록일자</span></th>
						    <td nowrap="nowrap"><input name="authorCreatDe" id="authorCreatDe" type="text" value="<c:out value='${authorManage.authorCreatDe}'/>" maxLength="50" size="20" readonly="readonly" title="등록일자" class="input_style1 input_w6"/></td>
						  </tr>
                        </table>
                    </div>
