...
//        model.addAttribute("resultList", customerInfoList);
    ...
    public String updateCustomerInfoView( @RequestParam("customerNum") String customerNum , @ModelAttribute("searchVO") CustomerInfoDefaultVO searchVO, Model model) throws Exception {
