...
public class MenuManageVO {
	...
	/**
	 * tmp_DeptId attribute를 리턴한다.
	 *
	 * @return String
	 */
	public String getTmp_DeptId() {
		return tmp_DeptId;
	}

	/**
	 * tmp_DeptId attribute 값을 설정한다.
	 *
	 * @param tmp_DeptId
	 *            String
	 */
	public void setTmp_DeptId(String tmp_DeptId) {
		this.tmp_DeptId = tmp_DeptId;
	}
