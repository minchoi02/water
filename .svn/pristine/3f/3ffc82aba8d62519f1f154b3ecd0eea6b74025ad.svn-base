                    ...
                    <div class="tablestyle_2" >
                        <table summary="롤을 수정하는 테이블입니다.롤 코드,롤 명,롤 패턴,설명,롤 타입,롤 Sort,등록일자 정보를 담고 있습니다.">
						  <tr>
						    ...
						    <td nowrap="nowrap"><input name="roleCode" id="roleCode" type="text" value="<c:out value='${roleManage.roleCode}'/>" size="30" readonly="readonly" title="롤 코드" class="input_style1 input_w1"  /></td>
						  </tr>
						  <tr>
						  ...
						  <tr>
						    ...
						    <td nowrap="nowrap"><input name="roleCreatDe" id="roleCreatDe" type="text" value="<c:out value='${roleManage.roleCreatDe}'/>" maxLength="50" size="20" title="등록일자" readonly="readonly" class="input_style1 input_w6" /></td>
						  </tr>
                        </table>
                    </div>
