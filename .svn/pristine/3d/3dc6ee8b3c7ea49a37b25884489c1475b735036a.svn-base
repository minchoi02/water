...
<section class="panel-wrap">
	...
	<form:form commandName="linkVO" name="linkVO" action="${pageContext.request.contextPath}/sys/link/llm/insertLinkListManage.do" method="post">
		 ...
		 <div class="table-box table-row table-col-6 y-scroll content-height-1">
			<table>
				<tr>
					...
					<td colspan="3">
<%-- 						<form:input path="lnkNm" id="lnkNm" title="연계정보명" size="20" maxlength="20" class="input_style1 input_w6" value="${result.lnkNm}" /> --%>
	...
	<div class="panel-footer">
  		<div class="btn-area">
            <button type="button" class="btn btn-primary btn-lg" onclick="javaScript:fnUpdate(); return false;">입력</button>
