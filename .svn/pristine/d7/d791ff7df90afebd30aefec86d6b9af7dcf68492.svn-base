...
public class UserManageDAO extends EgovAbstractDAO{
    ...
    public int checkIdDplct(String checkId){
        return (Integer)select("userManage.checkIdDplct", checkId);
    }
    ...
    public void deleteUser(String delId){
        delete("userManage.deleteUser", delId);
    }
    ...
    public String insertUser(UserManageVO userManageVO){
        return (String)insert("userManage.insertUser", userManageVO);
    }
    ...
    public UserManageVO selectUser(String uniqId){
        return (UserManageVO) select("userManage.selectUser", uniqId);
    }
	...
	public List<?> selectUserList(UserDefaultVO userSearchVO){
        return list("userManage.selectUserList", userSearchVO);
    }
	public List<?> selecAuthortUserList(UserDefaultVO userSearchVO){
		return list("userManage.selecAuthortUserList", userSearchVO);
	}

	public List<?> selectUserListExcel(UserDefaultVO userSearchVO){
		return list("userManage.selectUserListExcel", userSearchVO);
	}
    ...
    public int selectUserListTotCnt(UserDefaultVO userSearchVO) {
        return (Integer)select("userManage.selectUserListTotCnt", userSearchVO);
    }
    ...
    public void updateUser(UserManageVO userManageVO){
        update("userManage.updateUser",userManageVO);
    }
    ...
    public String insertUserHistory(UserManageVO userManageVO){
    	return (String)insert("userManage.insertUserHistory", userManageVO);
    }
    ...
    public void updatePassword(UserManageVO passVO) {
        update("userManage.updatePassword", passVO);
    }
    ...
    public UserManageVO selectPassword(UserManageVO userManageVO){
    	return (UserManageVO) select("userManage.selectPassword", userManageVO);
    }

    /**
     * 업무사용자가 아이디를 기억하지 못할 때 아이디를 찾을 수 있도록 함
     * @param userManageVO 업무사용자 정보
     * @return String 업무사용자 아이디정보
     */
    public String selectId(UserManageVO userManageVO){
    	return (String) select("userManage.selectId", userManageVO);
    }
    /**
     * 업무사용자가 비밀번호를 기억하지 못할 때 비밀번호를 찾을 수 있도록 함
     * @param userManageVO 업무사용자 정보
    ...
    public String selectIdByPwFind(UserManageVO userManageVO){
    	return (String) select("userManage.selectIdByPwFind", userManageVO);
    }
