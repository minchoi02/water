...
public class EgovComUtlController {
	...
	public String moveToPage(@RequestParam("link") String linkPage, HttpSession session, @RequestParam(value = "baseMenuNo", required = false) String baseMenuNo, @RequestParam(value = "activeMenuId", required = false) String activeMenuId) {
		...
		System.out.println("baseMenuNo:"+baseMenuNo);
		System.out.println("activeMenuId:"+activeMenuId);
		return link;
	}
