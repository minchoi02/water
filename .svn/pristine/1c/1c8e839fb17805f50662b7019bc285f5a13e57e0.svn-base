package  egovframework.appn.sys.menu.mlm.service;
...
public interface MenuManageService {
	 ...
	 * @exception Exception
	 */
	MenuManageVO selectMenuManage(String menuNo) throws Exception;
	...
	List<?> selectMenuManageListExcel(ComDefaultVO vo) throws Exception;
	...
	int selectMaxMenuNo(MenuManageVO menuManageVO)throws Exception;

	void updateMenuOrder(List<MenuManage> menuManageList )  throws Exception;
