package egovframework.appn.sys.log.lgm.web;
...
import egovframework.appn.sys.log.lgm.service.SysLog;
import egovframework.appn.sys.log.lgm.service.SysLogService;
...
public class SysLogController {
	 ...
	 *
	 * @param sysLog
	 * @return sys/log/lgm/EgovSysLogList
	 * @throws Exception
	 */
	@RequestMapping(value="/sys/log/lgm/SelectSysLogList.do")
	 ...
	 * @param sysLog
	 * @param model
	 * @return sys/log/lgm/EgovSysLogInqire
	 * @throws Exception
	 */
	@RequestMapping(value="/sys/log/lgm/InqireSysLog.do")
	public String selectSysLog(@ModelAttribute("searchVO") SysLog sysLog,
		...
		return "sys/log/lgm/SysLogInqire";
	}
