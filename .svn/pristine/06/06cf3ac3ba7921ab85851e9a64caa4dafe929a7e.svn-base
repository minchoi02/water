package egovframework.appn.sys.author.uam.service.impl;
...
public class AuthorGroupDAO extends EgovAbstractDAO {
	...
	public List<AuthorGroupVO> selectAuthorGroupList(AuthorGroupVO authorGroupVO) throws Exception {
		return (List<AuthorGroupVO>) list("authorGroup.selectAuthorGroupList", authorGroupVO);
	}
	...
	public void insertAuthorGroup(AuthorGroup authorGroup) throws Exception {
		insert("authorGroup.insertAuthorGroup", authorGroup);
	}
	...
	public void updateAuthorGroup(AuthorGroup authorGroup) throws Exception {
		update("authorGroup.updateAuthorGroup", authorGroup);
	}
	...
	public void deleteAuthorGroup(AuthorGroup authorGroup) throws Exception {
		delete("authorGroup.deleteAuthorGroup", authorGroup);
	}
    ...
    public int selectAuthorGroupListTotCnt(AuthorGroupVO authorGroupVO) throws Exception {
        return (Integer)select("authorGroup.selectAuthorGroupListTotCnt", authorGroupVO);
    }
}