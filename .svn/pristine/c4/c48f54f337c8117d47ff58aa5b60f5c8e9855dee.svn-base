                    ...
                    <div class="tablestyle_2" >
                        <table summary="그룹을 수정하는 테이블입니다.그룹 ID,그룹 명,설명,등록일자 정보를 담고 있습니다.">
                          <tr style="display:none;">
                            ...
                            <td nowrap="nowrap"><input name="groupId" id="groupId" type="text" value="<c:out value='${groupManage.groupId}'/>" size="40" title="그룹 ID" class="input_style1 input_w1"/></td>
                          </tr>
                          <tr>
                            <th scope="col" class="essential"><span>그룹명</span></th>
                            <td nowrap="nowrap"><input name="groupNm" id="groupNm" type="text" value="<c:out value='${groupManage.groupNm}'/>" title="그룹명" maxLength="50" size="40" class="input_style1 input_w6" />&nbsp;<form:errors path="groupNm" /></td>
                          </tr>
                          <tr>
                            <th scope="col"><span>설명</span></th>
                            <td nowrap="nowrap"><input name="groupDc" id="groupDc" type="text" value="<c:out value='${groupManage.groupDc}'/>" title="설명" maxLength="50" size="50" class="input_style1 input_w3" /></td>
                          </tr>
                          <tr style="display:none;">
                            <th scope="col"><span>등록일자</span></th>
                            <td nowrap="nowrap"><input name="groupCreatDe" id="groupCreatDe" type="text" value="<c:out value='${groupManage.groupCreatDe}'/>" title="등록일자" maxLength="50" size="20" readonly="readonly" class="input_style1 input_w6"/></td>
                          </tr>
                        </table>
                    </div>
