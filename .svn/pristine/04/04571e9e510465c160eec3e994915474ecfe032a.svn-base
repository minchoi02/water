package egovframework.appn.cop.cmt.web;
...
import egovframework.appn.cop.cmt.service.EgovArticleCommentService;
...
//		commentVO.setSubPageSize(propertyService.getInt("pageSize"));
    ...
    public String updateArticleCommentView(@ModelAttribute("searchVO") CommentVO commentVO, ModelMap model, HttpServletRequest request) throws Exception {
