...
public class AuthorManageDAO extends EgovAbstractDAO {
	...
	public List<AuthorManageVO> selectAuthorList(AuthorManageVO authorManageVO) throws Exception {
        return (List<AuthorManageVO>) list("authorManage.selectAuthorList", authorManageVO);
    }
	...
	public List<AuthorManageVO> selectAuthorAllList(AuthorManageVO authorManageVO) throws Exception {
        return (List<AuthorManageVO>) list("authorManage.selectAuthorAllList", authorManageVO);
    }
    public String selectRoleCode() {
    	return (String)select("authorManage.selectRoleCode");
    }
    public String getAuthorCode(String treeCode) {
    	return (String)select("authorManage.selectAuthorCode",treeCode);
    }
    public void updateUserAuthor(UserManageVO userManageVO) {
    	update("authorManage.updateUserAuthor",userManageVO);
    }
    public void updateUserAuthor2(UserManageVO userManageVO) {
    	update("authorManage.updateUserAuthor2",userManageVO);
    }
