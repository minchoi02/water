package egovframework.appn.cop.bbs.service;
...
public class BoardVO extends Board implements Serializable {
    ...
    /** 운영자제한여부 */
    private String adminLimitAt = "Y";

    /** 파일첨부가능여부 */
    private String fileAtchAt = "Y";

    /** 파일첨부갯수 */
    private String fileAtchCnt = "3";

    /** 답장가능여부 */
    private String replyPosbAt = "N";
	...
	public String getReplyPosbAt() {
		return replyPosbAt;
	}

	public void setReplyPosbAt(String replyPosbAt) {
		this.replyPosbAt = replyPosbAt;
	}
