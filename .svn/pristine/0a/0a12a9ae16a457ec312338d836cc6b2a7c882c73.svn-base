...
public class CmmnDetailCode implements Serializable {
	...
	public String getCmmncodeRegAt() {
		return cmmncodeRegAt;
	}

	public void setCmmncodeRegAt(String cmmncodeRegAt) {
		this.cmmncodeRegAt = cmmncodeRegAt;
	}
